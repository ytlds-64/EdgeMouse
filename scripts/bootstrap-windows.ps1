...
Write-Host "1. Edit edgemouse.toml: both screen sizes and layout.peer_on. Keep peer.address as auto, or set a static LAN address."
Write-Host "2. Allow inbound UDP ports 43891 and 43892 plus TCP port 43893 in Windows Firewall."
Write-Host "3. Stop any running EdgeMouse agent, then run: `"$BinaryPath`" pair host `"$ConfigPath`""
Write-Host "4. Enter the displayed code on the Mac with: ./target/release/edgemouse pair join ./edgemouse.toml CODE"
