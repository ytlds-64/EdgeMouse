...
Write-Host "3. Edit edgemouse.toml: both screen sizes and layout.peer_on. Keep peer.address as auto, or set a static LAN address."
Write-Host "4. Allow inbound UDP ports 43891 and 43892 in Windows Firewall."
